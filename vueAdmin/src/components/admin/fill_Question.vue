  ...
  <div>
    ...
    <el-card>
      <div slot="header" class="clearfix">
        <span style="font-size: 14px">主观题</span>
      </div>
      <div class="boxcard">
    ...
    <el-table :data="tableData" border stripe style="width: 100%">
      ...
      <el-table-column prop="question" label="题目" width="250"></el-table-column>
      <el-table-column prop="answer" label="正确答案" width="250"></el-table-column>
...
export default {
  ...
  methods:{
    ...
    del(questionId){
      request.delete("api/fill/"+questionId).then((res=>{
        if(res){
